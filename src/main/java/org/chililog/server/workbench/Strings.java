...
public class Strings {
    ...
    public static final String URI_QUERY_STRING_PARAMETER_OR_HEADER_ERROR = PREFIX
            + "UriQueryStringParameterOrHeaderError";
    ...
    public static final String AUTHENTICAITON_BAD_USERNAME_PASSWORD_ERROR = PREFIX
            + "AuthenticationBadUsernameOrPasswordError";
