...
public class WebSocketServerHandshaker00 extends WebSocketServerHandshaker {
    ...
    private static Log4JLogger _logger = Log4JLogger.getLogger(WebSocketServerHandshaker00.class);
    ...
    public void executeOpeningHandshake(ChannelHandlerContext ctx, HttpRequest req) {
        _logger.debug("Channel %s web socket spec version 00 handshake", ctx.getChannel().getId());
