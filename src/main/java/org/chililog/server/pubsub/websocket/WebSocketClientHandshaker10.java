...
public class WebSocketClientHandshaker10 extends WebSocketClientHandshaker {
	...
	public void beginOpeningHandshake(ChannelHandlerContext ctx, Channel channel) {
		...
		request.addHeader(WebSocketServerHandshakerFactory.SEC_WEBSOCKET_KEY, key);
		...
		request.addHeader(WebSocketServerHandshakerFactory.SEC_WEBSOCKET_VERSION, "8");
	...
	public void endOpeningHandshake(ChannelHandlerContext ctx, HttpResponse response)
		...
		String accept = response.getHeader(WebSocketServerHandshakerFactory.SEC_WEBSOCKET_ACCEPT);
