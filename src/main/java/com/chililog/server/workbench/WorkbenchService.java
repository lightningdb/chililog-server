...
public class WorkbenchService
{
    ...
    public void start()
    {
        ...
        _logger.info("Starting Workbench Web Sever on " + AppProperties.getInstance().getWorkbenchHost() + ":"
                + AppProperties.getInstance().getWorkbenchPort() + "...");
        ...
        ExecutionHandler executionHandler = new ExecutionHandler(new OrderedMemoryAwareThreadPoolExecutor(
                appProperties.getWorkbenchTaskThreadPoolSize(), appProperties.getWorkbenchTaskThreadPoolMaxChannelMemorySize(),
