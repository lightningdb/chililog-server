...
public class DelimitedRepositoryController extends RepositoryController
{
    ...
    public RepositoryEntryBO parse(String textEntry)
    {
        try
        {
            ...
            {
                String key = delimitedField.field.getName();
                String textValue = null;
                Object value = null;
                try
                {
                    textValue = ss[delimitedField.arrayIndex];
                    value = delimitedField.field.parse(textValue);
     ...
     */
    private class DelimitedFieldInfo
    {
        public int arrayIndex;
        public RepositoryFieldInfoBO field;
