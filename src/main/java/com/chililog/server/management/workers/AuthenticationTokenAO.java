...
import com.chililog.server.management.workers.AuthenticationAO.ExpiryType;
...
public class AuthenticationTokenAO
{
    ...
    public String toString()
    {
        try
        {
            ...
            sb.append(json);
            sb.append("~~~");
            sb.append(CryptoUtils.createSHA512Hash(json, appProperties.getManagementApiAuthenticationHashSalt(), false));
    ...
    public static AuthenticationTokenAO fromString(String tokenString) throws ChiliLogException
    {
        ...
        if (!CryptoUtils.verifyHash(json, appProperties.getManagementApiAuthenticationHashSalt(), hash))
        {
            throw new ChiliLogException(Strings.AUTHENTICAITON_TOKEN_INVALID_ERROR);
        }
