...
SC.STRINGS = {
 // ********************************************************
  ...
  '_admin.repo.name.invalid': 'Repository Name "%a" contains invalid characters. Only lower case letters (a-z), digits (0-9) and underscore (_) characters allowed.',
  ...
  '_admin.repo.startupStatus.online': 'Online. <span class="help">Start repository when server starts.</span>',
  '_admin.repo.startupStatus.offline': 'Offline. <span class="help">Repository is not started. You must manually start the repository after the server starts.</span>',
  '_admin.repo.currentStatus': 'Current Status',
  '_admin.repo.storeEntries' : 'Store Log Entries?',
  '_admin.repo.storeEntries.yes' : 'Yes. <span class="help">Save log entries to the database so they can be searched at a later time.</span>',
  '_admin.repo.storeEntries.no' : 'No. <span class="help">Do not save log entries. Entries cannot be search.</span>',
  '_admin.repo.storageQueueDurable' : 'Storage Queue Durable?',
  '_admin.repo.storageQueueDurable.yes' : 'Yes. <span class="help">Queued data saved to disk to prevent loss of data if server goes down.</span>',
  '_admin.repo.storageQueueDurable.no' : 'No. <span class="help">Queued data not saved to disk to improve throughput.</span>',
  '_admin.repo.storageQueueWorkerCount' : 'Worker Thread Count',
  '_admin.repo.storageQueueWorkerCount.help' : 'Number of worker threads that writes log entries to the database. More workers means faster storage of entries and smaller queue size. However, more workers results in higher CPU and RAM utilization.',
  '_admin.repo.storageQueueWorkerCount.required' : 'Worker Thread Count required.',
  '_admin.repo.storageMaxKeywords' : 'Maximum Keywords',
  '_admin.repo.storageMaxKeywords.help' : 'Maximum number of keywords per log entry to save. The more keywords, the more memory that is used.',
  ...
  '_admin.repo.maxMemoryPolicy.page' : 'Page. <span class="help">When maximum memory is reached, new messages will be saved into page files.</span>',
  '_admin.repo.maxMemoryPolicy.drop' : 'Drop. <span class="help">When maximum memory is reached, new messages will be dropped and not processed.</span>',
  '_admin.repo.maxMemoryPolicy.block' : 'Block. <span class="help">When maximum memory is reached, force producers to wait before new messages can be sent.</span>',
